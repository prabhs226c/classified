    ...
    foreach ($versionList as $aV)
    {
        if ( $aV > $config['version']) {
            ...
            echo '<div style="padding: 20px">
                <span>Note:<br></span>
                <ol>
                    <li>Take backup of <code>includes/lang</code> folder. if you had changes in language files.</li>
                    <li>If update not work. Then You will need to upload QUICKAD-CMS-'.$aV.'.zip file from cpanel filemanager <code>admin / uploads</code> directory after come back to this page and refresh page You will see a install now button. <br>Install it Thanks</li>
                </ol>
            </div>';
