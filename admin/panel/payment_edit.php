                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="2checkout_sandbox_mode"  class="form-control">
                                            <option value="production" <?php if(get_option('2checkout_sandbox_mode') == 'live') echo "selected"; ?>>Live Mode</option>
                                            <option value="sandbox" <?php if(get_option('2checkout_sandbox_mode') == 'test') echo "selected"; ?>>Test Mode</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
